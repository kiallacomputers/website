  ...
  <div class="flex items-center justify-center font-quest">
    <div class="flex items-center w-[900px] mt-2">
      <div class="flex flex-col mt-4 w-full">
        <p
          class="font-bold text-5xl text-2xl mb-6 text-center w-full uppercase text-blue-700"
        >
          Weekly Specials
        </p>
        ...
        <div class="flex flex-col items-center justify-center mt-10 w-full">
          <div
            class="flex items-center justify-center text-center w-full mb-10"
          >
        ...
        <div class="flex flex-row items-center justify-center mt-20">
          <div class="flex items-center justify-center text-center w-full">
            <a
              ...
              href="mailto:sales@kiallacomputers.com.au?Subject=Quote Enquire"
              >For a Quote Just contact us!</a
            >
          </div>
        </div>
      </div>
