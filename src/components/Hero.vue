<template>
  ...
  <div class="flex flex-col mx-8 lg:mr-8 lg:ml-8 items-center justify-center">
    <div class="bg-[url('assets/hsbbgbanner.png')] w-[900px] text-center justify-center">
      <p class="font-bold text-4xl font-quest text-[#144C84] mt-8 capitalize">
        I.T. SUPPORT
      </p>
      <p class="font-extrabold text-2xl mb-6 font-quest text-[#144C84] capitalize">
